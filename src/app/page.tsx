  ...
  return (
    <div className="my-16 transition-all duration-300">
      ...
      <div className="mt-16 px-6 md:px-12">
        <h2 className="text-[35px] font-extrabold text-[#029bc0] text-center mb-8">Featured Projects</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.slice(0,3)?.map((project: TProject) => <ProjectCard key={project?._id} project={project} />)}
        </div>
      </div>
    </div>
  );
